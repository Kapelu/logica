/*
Programa una función que promedie los valores de un array. Por ejemplo, miFuncion([1, 2, 3, 4]) devolverá 2.5.
*/

const promediarArray = (arr = undefined) => {
...
module.exports = { promediarArray }

/*Explicación:
1. La función `promediarArray` toma un argumento `arr` que se espera sea un array de números.
...
6. Finalmente, se retorna el resultado de dividir la suma total por la longitud del arreglo, lo que da el promedio de los números en el arreglo.  
*/  